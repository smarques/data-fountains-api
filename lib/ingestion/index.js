...
ingestor.validate = data => {
  ...
  if(!data[ingestor.FIELD_NAMES.QUALITY] || !validator.isFloat(data[ingestor.FIELD_NAMES.QUALITY]+''))
  {
    throw `${ingestor.FIELD_NAMES.QUALITY} needs to be a float, , received '${data[ingestor.FIELD_NAMES.QUANTITY]}'`;
  }
